...
const fn ratio_divide(r1: (i64,i64),r2: (i64,i64)) -> (i64,i64){
    ...
    ((num/gcd128(num,denom)) as i64,(denom/gcd128(num,denom)) as i64)
}
...
impl<A: Period,B: Period> Period for RatioMultiply<A,B>{
    const NUMERATOR: i64 = ratio_multiply((A::NUMERATOR,A::DENOMINATOR),(B::NUMERATOR,B::DENOMINATOR)).0;
    const DENOMINATOR: i64 = ratio_multiply((A::NUMERATOR,A::DENOMINATOR),(B::NUMERATOR,B::DENOMINATOR)).0;
}
...
impl<A: Period,B: Period> Period for RatioDivide<A,B>{
    const NUMERATOR: i64 = ratio_divide((A::NUMERATOR,A::DENOMINATOR),(B::NUMERATOR,B::DENOMINATOR)).0;
    const DENOMINATOR: i64 = ratio_divide((A::NUMERATOR,A::DENOMINATOR),(B::NUMERATOR,B::DENOMINATOR)).0;
}
...
pub type Mega = Ratio<1_000_0000,1>;
pub type Kilo = Ratio<1_000,1>;
pub type Unit = Ratio<1,1>;
pub type Mili = Ratio<1,1000>;
pub type Micro = Ratio<1,1000000>; 
